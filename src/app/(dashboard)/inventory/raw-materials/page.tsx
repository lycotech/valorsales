...
export default function RawMaterialInventoryPage() {
  ...
  const fetchInventory = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/inventory/raw-materials?${params}`)
      ...
      console.error('Failed to fetch raw material inventory:', error)
    } finally {
      setLoading(false)
    }
  ...
  const getStockProgress = (item: RawMaterialInventory) => {
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <Typography variant='body2' color='textSecondary'>
            Manage and monitor raw material stock levels
          </Typography>
        </div>
      </div>
