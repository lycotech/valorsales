...
-- AddForeignKey
ALTER TABLE `product_replacements` ADD CONSTRAINT `product_replacements_saleId_fkey` FOREIGN KEY (`saleId`) REFERENCES `sales`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `product_replacements` ADD CONSTRAINT `product_replacements_productId_fkey` FOREIGN KEY (`productId`) REFERENCES `products`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
